...
{
    /// <summary>
    /// Clase que representa un pago con PinPad Móvil
    /// </summary>
    [DataContract]
    public class ProcesarMovimientoPagoPinPadMovilRequest
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember(Name = "folioAutorizacionPinPadMovil")]
        public string FolioAutorizacionPinPadMovil { get; set; }
