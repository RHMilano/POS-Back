...
{
    /// <summary>
    /// Imprime las notas de credito
    /// </summary>
    public class PrintTicketEmisionNotaCredito : BaseBusiness
    {
        ...
        /// </summary>
        public PrintTicketEmisionNotaCredito(TokenDto token)
        {
            try
            {
                this.PrinterName = "";
        ...
        /// <summary>
        /// Imprime los tickets de nota de credito
        /// </summary>
        public OperationResponse PrintNow(string folioNotaCredito)
        {
        ...
        {
            PrintLecturaResponse[] printLecturaResponses = repository.getNotaCredito(this.FolioNotaCredito);
            foreach (var r in printLecturaResponses)
            {
                ...
                SizeF size = ev.Graphics.MeasureString(item.Texto, tmpFont, 9999);
                ...
                pos.X = Convert.ToInt32(startX);
                pos.Y = Convert.ToInt32(startY + Offset);
