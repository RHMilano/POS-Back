...
namespace Milano.BackEnd.Business.ImpresionMM
{
    ...
    /// Imprime los cupones
    /// </summary>
    public class PrintCupon : BaseBusiness
    {
        ...
        /// </summary>
        public PrintCupon(TokenDto token)
        {
            try
            {
                this.PrinterName = "";
        ...
        /// </summary>
        public OperationResponse PrintNow(string folioCupon)
        {
            OperationResponse operationResponse = new OperationResponse();
            try
            {
                this.cuponFolio = folioCupon;
        ...
        {
            PrintLecturaResponse[] printLecturaResponses = repository.getCupon(this.cuponFolio);
