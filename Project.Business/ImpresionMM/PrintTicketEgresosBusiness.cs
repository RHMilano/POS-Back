...
{
    public class PrintTicketEgresosBusiness : BaseBusiness
    {
        ...
        private PrintTicketEgresosRequest printTicketEgresosRequest;
        ...
        private void SetPrinterConfig()
        {
            ...
            //    printDocument.DefaultPageSettings.PaperSize.Width = 10;
